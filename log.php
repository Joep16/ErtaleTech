...
<body>
      ...
      <div class="inner-box">
        <div class="forms-wrap">
          <form action="fetch.php" method="post" enctype="multipart/form-data" autocomplete="off" class="sign-in-form">
            <div class="logo">
              <img src="./assets/images/edited.png" alt="Ertaletech" />
              <h3>Ertale Tech</h3>
            </div>
        ...
        <div class="carousel carousel-light">
          <div class="images-wrapper">
            <img src="./assets/images/stock.jpg" class="image img-1 show" alt="" />
            <img src="./assets/images/stock.jpg" class="image img-2" alt="" />
            <img src="./assets/images/stock.jpg" class="image img-3" alt="" />
          </div>
  ...
  <!-- JavaScript -->
  <script src="./assets/js/applog.js"></script>
  <script>
   // Get the modal
