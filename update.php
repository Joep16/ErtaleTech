...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE `users` SET `name` = '$name', `email` = '$email', `phone` = '$phone' $password_update WHERE `id` = '$user_id'";

    $result = mysqli_query($conn, $sql);

    if ($result) {
        header("Location: status.php?msg=Profile updated successfully");
    } else {
...
<body>
   ...
   <div class="container" style="background-color:rgba(240, 240, 240, 0.1)">
      ...
      </br> <h3 style="color:white">EDIT YOUR PROFILE</h3>
      </div>
