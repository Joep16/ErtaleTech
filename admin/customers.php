      ...
      <tbody>
        ...
        ?>
          ...
          <td><?php echo $row["id"] ?></td>
            ...
            <td>
  <a href="sells.php?user_id=<?php echo urlencode($row["id"]); ?>" class="btn btn-dark">Sell</a>
  <a href="message.php?id=<?php echo urlencode($row["id"]); ?>" class="btn btn-dark">Message</a>
</td>
          </tr>
        <?php
        }
...
if(isset($_GET['search']))
{
  ...
  $query = "SELECT * FROM users WHERE CONCAT(name,phone,email) LIKE '%$filtervalues%'";
